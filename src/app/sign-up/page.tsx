      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-7xl flex-col">
        ...
        <section className="grid flex-1 items-center gap-12 py-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(24rem,0.55fr)]">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">New hire paperwork</p>
          ...
          <section className="border border-border bg-card p-6 sm:p-8" aria-labelledby="sign-up-title">
            <h2 className="font-heading text-2xl font-semibold" id="sign-up-title">Create account</h2>
            <AuthForm mode="sign-up" />
            <p className="mt-7 border-t border-border pt-5 text-sm text-muted-foreground">
              Already on payroll?{" "}
              <Link className="text-foreground underline underline-offset-4 hover:text-primary" href="/sign-in">
                Sign in
              </Link>
            </p>
          </section>
