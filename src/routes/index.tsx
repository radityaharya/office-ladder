          ...
          <section className="grid flex-1 items-center gap-12 py-14 lg:grid-cols-[minmax(0,0.9fr)_minmax(24rem,0.65fr)]">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-muted-foreground">
                Create a private room for your group, or enter the code somebody dropped in the
                chat.
              </p>
            </div>
            ...
            <section className="grid flex-1 items-center gap-14 py-14 lg:grid-cols-[minmax(0,1fr)_minmax(20rem,0.55fr)] lg:py-20">
              <div className="max-w-4xl">
                ...
                <p className="mt-7 max-w-2xl text-base leading-8 text-muted-foreground sm:text-lg">
                  Roll the dice, collect money and reputation, and reach Director before your
                  coworkers do.
                </p>
              ...
              <div className="border-y border-border py-3">
                {steps.map(([title, body]) => (
                  <div
                    className="grid grid-cols-[5rem_1fr] gap-5 border-b border-border py-6 last:border-b-0"
                    key={title}
                  >
